...
echo Delete previously generated cs code files 
 ...
 DEL /F "..\MF.Domain\Domain\2_t4DomainViewModelsGenerate.cs"	
 ::DEL /F "..\MF.Domain\Mapping\3_t4DomainMappingProfileGenerate.cs"	
 DEL /F "..\MF.Domain\Service\4_t4DomainServicesGenerate.cs"	
 ::DEL /F "..\MF.Api\Controllers\5_t4ApiControllerGenerate.cs"	
 ::DEL /F "..\MF.Test\6_t4IntegrationTestGenerate.cs"
echo .
echo Run all T4s...
echo -generate entity helpers
%tt% "1_t4EntityHelpersGenerate.tt" -out "1_t4EntityHelpersGenerate.cs"
echo -generate domain classes
%tt% "..\MF.Domain\Domain\2_t4DomainViewModelsGenerate.tt" -out "..\MF.Domain\Domain\2_t4DomainViewModelsGenerate.cs"
echo -generate mapper classes
::%tt% "..\MF.Domain\Mapping\3_t4DomainMappingProfileGenerate.tt" -out "..\MF.Domain\Mapping\3_t4DomainMappingProfileGenerate.cs"	
echo -generate services classes
%tt% "..\MF.Domain\Service\4_t4DomainServicesGenerate.tt" -out "..\MF.Domain\Service\4_t4DomainServicesGenerate.cs"	
echo -generate controller classes
::%tt% "..\MF.Api\Controllers\5_t4ApiControllerGenerate.tt" -out "..\MF.Api\Controllers\5_t4ApiControllerGenerate.cs"	
echo -generate test classes
::%tt% "..\MF.Test\6_t4IntegrationTestGenerate.tt" -out "..\MF.Test\6_t4IntegrationTestGenerate.cs"	
echo T4s completed.
pause
:END